  ...
  return (
    <div className="py-28 h-screen">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          >
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <p className="text-foreground/70">Let's discuss your project</p>
        ...
        >
          <p className="text-foreground/70">
            I'm currently open to full-time software engineering positions and
            interesting project collaborations. Let's create something amazing
            together!
          </p>
        </motion.div>
      </div>
